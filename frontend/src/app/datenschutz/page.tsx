    ...
    return (
        <div className="container py-12 md:py-16">
            ...
            <div className="prose prose-zinc max-w-none dark:prose-invert">
                ...
                <p>Zum Schutz vor Spam nutzen wir Google reCAPTCHA v3. Anbieter ist Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland. reCAPTCHA analysiert das Verhalten des Websitebesuchers anhand verschiedener Merkmale. Diese Analyse beginnt automatisch, sobald der Websitebesucher die Website betritt bzw. mit dem Formular interagiert. Zur Analyse wertet reCAPTCHA verschiedene Informationen aus (z. B. IP-Adresse, Verweildauer des Websitebesuchers auf der Website oder vom Nutzer getätigte Mausbewegungen). Die bei der Analyse erfassten Daten werden an Google weitergeleitet. Die Datenverarbeitung erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO; wir haben ein berechtigtes Interesse daran, unsere Webangebote vor missbräuchlicher automatisierter Ausspähung und vor SPAM zu schützen. Weitere Informationen zu Google reCAPTCHA sowie die Datenschutzerklärung von Google entnehmen Sie folgenden Links: <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">https://policies.google.com/privacy</a> und <a href="https://policies.google.com/terms" target="_blank" rel="noopener noreferrer">https://policies.google.com/terms</a>.</p>
                <p>Für die Verarbeitung der Daten wird im Rahmen des Absendevorgangs Ihre Einwilligung eingeholt und auf diese Datenschutzerklärung verwiesen. Die Daten werden ausschließlich für die Verarbeitung der Konversation verwendet und anschließend zur Beantwortung Ihrer Anfrage an uns per E-Mail weitergeleitet. Die E-Mails werden mittels des Dienstleisters Resend (Resend Inc., 1046 Kearny St, San Francisco, CA 94133, USA) versendet, mit dem wir einen Vertrag zur Auftragsverarbeitung abgeschlossen haben, der Standardvertragsklauseln beinhaltet, um ein angemessenes Datenschutzniveau sicherzustellen. Weitere Informationen: <a href="https://resend.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer">https://resend.com/legal/privacy-policy</a>.</p>
